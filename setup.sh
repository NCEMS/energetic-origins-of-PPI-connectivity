...
#conda create --name snakemake -c bioconda -y snakemake=7.32.4 python=3.10
conda create -n snakemake-new -c conda-forge -c bioconda -c defaults snakemake=7.32.4 python=3.10
...
#cp -r ../signalp6_fast 2-sequence-parsing/python-scripts/
