...
rule all:
    input:
        rules.collect_alphafold_targets.output,
...
rule collect_alphafold_targets:
    input:
        checkpoint=checkpoints.prepare_structures_checkpoint
    output:
        dynamic(f"{config['dG_predictions']['output_dir']}/alphafold/{{node}}/result_model_1_pred_0.pdb")
