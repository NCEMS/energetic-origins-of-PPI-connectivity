...
| 17 | inviable_annotations.txt | Essential proteins from Saccharomyces Genome Database | Downloaded from yeastgenome.org |
| 17 | inviable_annotations-mod.txt | Essential protein from Saccharomyces Genome Database, reformatted | Downloaded from yeastgenome.org |

| 18 | Y2H_union-clean.txt |
| 18 | Y2H_union-clean_edges.csv |
| 18 | Y2H_union-clean_nodes.csv |
| 18 | Y2H_union.txt |

| 19 | meltome-atlas-ma_0010.txt |
